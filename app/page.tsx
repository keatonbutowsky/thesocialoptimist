...
export default function HomePage() {
  const featured = getCaseStudyMetas().slice(0, 3);

  return (
    <>
      {/* HERO */}
      <section className="relative overflow-hidden bg-pink-cherub">
        <div className="tso-container relative grid items-center gap-12 py-24 md:grid-cols-[1.1fr_0.9fr] md:py-32">
          <div>
            <p className="tso-eyebrow text-dark-brown/70">est. 2026 · Dallas, TX</p>
            <h1 className="mt-6 font-display text-5xl leading-[1.05] tracking-wider2 text-cloud-cotton sm:text-6xl md:text-7xl">
              creative
              <br />
              optimists.
              <br />
            ...
            <p className="mt-8 max-w-prose2 text-lg text-dark-brown/80">
      ...
      {/* MISSION STRIP */}
      <section className="tso-container py-24">
        <div className="grid gap-12 md:grid-cols-[0.6fr_1.4fr]">
          ...
          <div className="space-y-6 text-lg text-dark-brown/80">
            <p>
              Social media can be powerful when it&apos;s built on connection
              instead of manipulation. We work with founders who want to grow
              the right way — culturally aware, creatively brave, and rooted in
              community.
            </p>
            <p>
              The optimist&apos;s edge: psychology, AI, and a trend-starter
              mindset, pointed at the platforms your audience actually lives on.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="tso-container">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              ...
              { name: "Social Savvy", price: "$3,500", note: "20 posts · unlimited platforms · content shoot · paid + SEO" },
              { name: "Social Optimist", price: "$5,000", note: "Full creative team · everything in Savvy, dialed up" },
            ].map((t) => (
      ...
      <section className="tso-container py-24">
        <div className="flex items-end justify-between gap-6">
          ...
          <Link href="/portfolio" className="tso-link text-sm">
            All work →
          </Link>
        </div>
      ...
      <section className="bg-dark-brown text-cloud-cotton">
        <div className="tso-container flex flex-col items-center gap-8 py-24 text-center">
          <MonogramBadge size={88} className="opacity-90" />
          <h2 className="font-display text-4xl tracking-wider2 md:text-5xl">
